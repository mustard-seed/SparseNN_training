...
time mpirun -x LD_LIBRARY_PATH \
    ...
    python ImagenetVGG16Experiment.py --mode validate --config_file vgg16_sweep/config_imagenet_vgg16_dummy.yaml \
    --load_checkpoint 3  \
    --custom_sparsity 0.75 \
    --multiprocessing  | tee validate.txt
#time mpirun -x LD_LIBRARY_PATH \
#    -x OMP_NUM_THREADS \
#    -x PATH \
#    --map-by ppr:1:socket:pe=$num_core_per_socket --report-bindings \
#    --oversubscribe -n $num_proc \
#    python ImagenetResNet50Experiment.py --mode validate --config_file /homes/jmusel/jmuse/resnet50_sweep/imagenet_resnet50_pretrained_iter_BPc2r4_quantize_log/config_imagenet_resnet50_pretrained_iter_BPc2r4_quantize.yaml \
#    --load_checkpoint 2  \
#    --checkpoint_path /homes/jmusel/jmuse/resnet50_sweep/imagenet_resnet50_pretrained_iter_BPc2r4_quantize_log/ckpt_epoch10.pth.tar \
#    --custom_sparsity 0.75 \
#    --multiprocessing  | tee validate.txt
#time mpirun -x LD_LIBRARY_PATH \
#      -x OMP_NUM_THREADS \
